...
import com.example.qcmtest.MainActivity
...
class RecyclerViewAdapter(private val activity: MainActivity, val items: MutableMap<String, String>) : RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder>(){
    ...
    private var itemTitles : ArrayList<String> = initKeys()
    private var itemDefinition : ArrayList<String> = initDef()

    private val itemImages = intArrayOf(
            R.drawable.newone ,
            R.drawable.newone,R.drawable.newone ,
            R.drawable.newone, R.drawable.newone ,
            R.drawable.newone,R.drawable.newone
    )
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.textTitle.setOnClickListener { v:View ->
